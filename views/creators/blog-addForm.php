...
<div class="content">
    <?php if($msg != '' && $msg == "Blogs added successfully") { ?>
    ...
    <div class="container">
        <div class="row">
            <h1 style="font-family: Times New Roman;">ADD BLOGS</h1>
            <div class="col-md-12">
                <form id="blogForm" action="<?php echo $base_url;?>/controllers/creators/handleSubmit_controller.php" method="POST" enctype="multipart/form-data" onsubmit="return blogSubmit(event)">
                    <input type="hidden" name="type" value="blog">
                    
                    <div class="form-group">
                        <input type="text" class="form-control" id="title" name="title" placeholder="Add Title" />
                        <div class="err_msg" id="titleError" style="display: none; color: red; font-weight: bold;">Title is required</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="err_msg" id="descriptionError" style="display: none; color: red; font-weight: bold;">Description is required</div>
                    </div>
